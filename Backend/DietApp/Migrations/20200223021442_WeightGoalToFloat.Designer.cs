...
namespace DietApp.Migrations
{
    ...
    [Migration("20200223021442_WeightGoalToFloat")]
    partial class WeightGoalToFloat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DietApp.Domain.Models.GoalParticipation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<float>("CarbsLimit")
                        .HasColumnType("real");

                    b.Property<float>("CarbsLimitLower")
                        .HasColumnType("real");

                    b.Property<float>("CarbsLimitUpper")
                        .HasColumnType("real");

                    b.Property<float>("FatLimit")
                        .HasColumnType("real");

                    b.Property<float>("FatLimitLower")
                        .HasColumnType("real");

                    b.Property<float>("FatLimitUpper")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("ProteinLimitLower")
                        .HasColumnType("real");

                    b.Property<float>("ProteinLimitUpper")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("DietApp.Domain.Models.GoalParticipation", b =>
                {
                    ...
                    b.HasOne("DietApp.Domain.Models.User", "InvitedUser")
                        .WithOne("Goal")
                        .HasForeignKey("DietApp.Domain.Models.GoalParticipation", "InvitedUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
